...
from ml.task2_embedding.data import load_combined_dataset, load_validation_dataset, get_negative_samples
...
# Checkpoint loading
checkpoint_path = os.path.join(models_dir, "hetero_sage_model_task2_embedding.pt")
start_epoch = 0
...
save_path = os.path.join(models_dir, "hetero_sage_model_task2_embedding.pt")
torch.save({
