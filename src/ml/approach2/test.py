...
from ml.approach2.data import load_dataset, load_validation_dataset
...
def run_test():
    ...
    print("Loading model for Approach 2...")
    ...
    # Using the standard load_dataset from approach2
    ...
    print("\n" + "=" * 60)
    print("APPROACH 2 EVALUATION RESULTS")
    print("=" * 60)
