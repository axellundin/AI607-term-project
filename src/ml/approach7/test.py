...
def predict_class(logits):
    """
    CORN prediction: Convert 3 logits to class predictions.
    ...
    # CORN prediction: sum of probabilities > 0.5
...
def run_test():
    ...
    model_path = os.path.join(models_dir, "hetero_sage_model_approach7.pt")
    ...
    print("\n" + "=" * 60)
    print("APPROACH 7 (CORN) EVALUATION RESULTS")
    print("=" * 60)
