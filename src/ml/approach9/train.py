...
from ml.approach9.data import load_dataset, load_validation_dataset, get_negative_samples
...
# Checkpoint loading
checkpoint_path = os.path.join(models_dir, "hetero_sage_model_approach9.pt")
start_epoch = 0
...
if os.path.exists(checkpoint_path):
    ...
    # Load pretrained weights from approach5_large (excluding decoder)
    pretrained_checkpoint_path = os.path.join(models_dir, "hetero_sage_model_approach5_large.pt")
...
save_path = os.path.join(models_dir, "hetero_sage_model_approach9.pt")
torch.save({
