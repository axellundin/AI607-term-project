...
from task2.data_stage2 import load_combined_dataset, load_validation_dataset, get_negative_samples
...
parser.add_argument("--input-path", type=str, default="task2_stage1.pt")
parser.add_argument("--output-path", type=str, default="task2_stage2.pt")
...
pretrained_checkpoint_path = os.path.join(models_dir, args.input_path)
...
# Checkpoint loading
checkpoint_path = os.path.join(models_dir, args.output_path)
start_epoch = 0
